...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const currentSection = sections.find(
        (section) =>
          section.top <= scrollPosition && section.bottom > scrollPosition
      );
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-white dark:from-gray-900 dark:to-gray-950 relative overflow-hidden py-8 sm:py-16 lg:py-20"
    >
      <div className="container relative flex flex-col lg:flex-row items-center justify-center mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 2xl:px-32 max-w-7xl">
        ...
        <div className="w-full lg:w-1/2 animate-slide-up mb-8 lg:mb-0 lg:pr-8 xl:pr-12">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mb-4 sm:mb-6 h-10 sm:h-12 md:h-14 flex items-center dark:text-white">
            I'm a{" "}
            <span className="text-indigo-600 font-bold dark:text-indigo-400 ml-1 sm:ml-2">
              {displayText}
            </span>
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-300 mb-6 sm:mb-8 max-w-lg lg:max-w-xl leading-relaxed">
            Experienced React Frontend Developer specializing in crafting
            scalable, high-performance web applications. Dedicated to creating
            seamless user experiences through innovative solutions, solving
            complex problems, and tackling intricate technical challenges with
          ...
          <div className="flex flex-row flex-wrap gap-4 sm:gap-6 items-center">
            ...
            <div className="flex flex-wrap justify-start gap-2 sm:gap-3 md:gap-4 animate-slide-right">
              <a
                href="https://wa.me/923151728837"
                target="_blank"
                rel="noopener noreferrer"
                className="group w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gray-100 dark:bg-gray-700 hover:bg-indigo-200 dark:hover:bg-indigo-700 flex items-center justify-center rounded-full transition-all duration-300 ease-in-out"
              >
              ...
              <a
                href="https://github.com/junaid-ash4275"
                target="_blank"
                rel="noopener noreferrer"
                className="group w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gray-100 dark:bg-gray-700 hover:bg-indigo-200 dark:hover:bg-indigo-700 flex items-center justify-center rounded-full transition-all duration-300 ease-in-out"
              >
              ...
              <a
                href="https://linkedin.com/in/junaid-ashraf-b927b21a1"
                target="_blank"
                rel="noopener noreferrer"
                className="group w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gray-100 dark:bg-gray-700 hover:bg-indigo-200 dark:hover:bg-indigo-700 flex items-center justify-center rounded-full transition-all duration-300 ease-in-out"
              >
              ...
              <a
                href="mailto:junaid.ashraf4275@gmail.com"
                className="group w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gray-100 dark:bg-gray-700 hover:bg-indigo-200 dark:hover:bg-indigo-700 flex items-center justify-center rounded-full transition-all duration-300 ease-in-out"
              >
          ...
          <div className="code-editor-container">
            ...
            <div className="code-editor-header">
              ...
              <div className="code-editor-language">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="code-editor-language-icon"
                >
            ...
            <pre className="code-editor-content">
              ...
              <code className="block">
                ...
                <span className="text-blue-600 dark:text-blue-400">:</span>{" "}
                <span className="text-orange-600 dark:text-orange-400">
                  "Full Stack Developer | MERN Stack Dev" | MEAN Stack Dev
                </span>
                <span className="text-blue-600 dark:text-blue-400">,</span>
                <br />{" "}
                <span className="text-purple-600 dark:text-purple-400">
          ...
          <div className="tile-container">
            <div className="tile-content">
              ...
              <div className="tile-text">
                ...
                <span className="tile-label text-gray-600 dark:text-gray-300">
                  Projects Completed
                </span>
              </div>
            </div>
      ...
      >
        ...
        {/* Menu Content */}
        <div
          className={`absolute top-20 right-4 w-64 max-w-[calc(100vw-2rem)]
          ...
          ${
            isMobileMenuOpen
              ...
              : "translate-y-8 scale-95 -rotate-1"
          }`}
        >
          {/* Navigation Items */}
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div
              ...
              style={{
                ...
                top: `${
                  (100 / navigationItems.length) * 0.1 +
      ...
      <div
        className={`fixed bottom-4 right-4 lg:bottom-6 lg:right-6 z-40 transition-all duration-500 ease-in-out transform ${
          showScrollButton
